...
:- module(pubsub, [subscribed/1, subscribed/2, all_subscribed/1, all_subscribed/2, all_unsubscribed/0, all_unsubscribed/1, unsubscribed/1, unsubscribed/2, unsubscribed_from/1, unsubscribed_from/2, subscription/1, subscription/2, published/1, published/2, published/3]).
...
published(Topic, Payload) :-
	self(Source),
	published(Topic, Payload, Source).

published(Topic, Payload, Source) :-
	name(Pubsub),
	message_sent(Pubsub, pub(Topic, Payload, Source)).
